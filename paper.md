...
5. **Quality-driven adaptation**: Built-in quality metrics and optimization strategies, with separate handling for isotropic and anisotropic meshes
...
The library provides comprehensive quality assessment and improvement tools with separate handling for isotropic and anisotropic meshes:
...
`SOFIA` supports multiple adaptation strategies for both isotropic and anisotropic meshes:
